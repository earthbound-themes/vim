...
hi Cursor        guifg=#1c0037 ctermfg=234   guibg=#ffffff ctermbg=15
hi lCursor       guifg=#1c0037 ctermfg=234   guibg=#ffffff ctermbg=15
hi CursorIM      guifg=#1c0037 ctermfg=234   guibg=#ffffff ctermbg=15
hi Directory     guifg=#f56b3c ctermfg=203      guibg=#1c0037 ctermbg=234  gui=bold
hi ErrorMsg      guifg=#ee1111 ctermfg=9         guibg=#1c0037 ctermbg=234
hi VertSplit     guifg=#1c0037 ctermfg=234   guibg=#fafd51 ctermbg=227
hi LineNr        guifg=#94b2b2 ctermfg=109    guibg=#360a5f ctermbg=53
hi ModeMsg       guifg=#acaf6f ctermfg=143   guibg=#1c0037 ctermbg=234
hi MoreMsg       guifg=#acaf6f ctermfg=143   guibg=#1c0037 ctermbg=234
hi Normal        guifg=#ffffff ctermfg=15        guibg=#1c0037 ctermbg=234
hi Question      guifg=#acaf6f ctermfg=143   guibg=#1c0037 ctermbg=234
...
" status line
hi Title         guifg=#fafd51 ctermfg=227    guibg=#1c0037 ctermbg=234  gui=bold
hi Visual                              guibg=#6a6c23 ctermbg=58   gui=none
hi VisualNOS                           guibg=#1c0037 ctermbg=234
hi WarningMsg    guifg=#f56b3c ctermfg=203      guibg=#1c0037 ctermbg=234
...
hi CursorLine                          guibg=#360a5f ctermbg=53  gui=none
...
hi Error         guifg=#ee1111 ctermfg=9         guibg=#1c0037 ctermbg=234
hi Todo          guifg=#1c0037 ctermfg=234   guibg=#acaf6f ctermbg=143  gui=none
hi SignColumn                          guibg=#1c0037 ctermbg=234
